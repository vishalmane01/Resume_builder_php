...
<div class="d-flex align-items-center p-3" style="min-height: 100vh;">
    <div class="w-100">
        <main class="form-signin w-100 m-auto bg-white shadow rounded">
            <form method = "post" action = "actions/send.code.action.php">
                ...
                <div class="form-floating mb-4">
                    <input type="email" class="form-control"  name = "email_id" id="floatingEmail" placeholder="name@example.com" require>
